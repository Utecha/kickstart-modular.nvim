...
if version >= 508 || !exists("did_FreeBASIC_syntax_inits")
  if version < 508
    let did_FreeBASIC_syntax_inits = 1
  ...
  HiLink freebasicConsole		Special
